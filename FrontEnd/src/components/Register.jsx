        ...
        <div className='w-full h-screen bg-stone-700 bg-opacity-50 flex justify-center items-center absolute top-0'>
            <form id="register" onSubmit={handleSubmit} ref={formRef} className='w-[45%] h-[90vh] rounded-2xl bg-white flex flex-col justify-center items-center'>
                ...
                <div className='w-full px-20 pb-5 flex flex-col overflow-y-auto gap-10 h-[70%]'>
                    ...
                    <input className='border py-4 px-2' type="text" name='name' placeholder='Name' />
                    <input className='border py-4 px-2' type="text" name='email' placeholder='Email' />
                    ...
                    <div>
                        <input className='border px-2 py-2 text-gray-400' type="date" name="age" id="age" />
                    </div>
                    <div>
                        <input className='border px-2 py-2 text-black' type="password" name="password" id="password" placeholder='Password' />
                    </div>
                </div>
                <div className='w-full flex h-[20%] border-t border-gray-200 items-center justify-center'>
                    <button type='submit' className='w-[75%] h-[50%] rounded-full bg-black bg-opacity-90 text-white text-lg font-bold'>Sign in</button>
                </div>
            </form>
        </div>
    )
